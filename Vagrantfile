...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  ##nodejs
  config.vm.provision "shell", inline: "which npm || (sudo apt-get -y install python-software-properties python && curl -sL https://deb.nodesource.com/setup_4.x | sudo -E bash -
